...
function u(t) {
    for (var e = arguments, s = [], i = 1; i < arguments.length; i++)
        s[i - 1] = e[i];
    return (
        null != t &&
        s.some(function (e) {
    ...
    return (
        e.forEach(function (e) {
            !(function (t, e, s) {
                var i, n, a, o;
                if (
                    ![s._const.addElement, s._const.addTextElement].includes(
                        e[s._const.action]
                    )
                ) {
...
var L = {
    ...
    P = function (t, e) {
        ...
        if (
            n &&
            ((s.nodeName = e || "svg" === n[1] ? n[1] : n[1].toUpperCase()),
            ...
            t.replace(S, function (r, l) {
                ...
                if (d) {
                    if (
                        ...
                        s.node.childNodes.push({ nodeName: "#text", data: m }),
                            e.valueDiffing &&
                ...
                if (t.nodeName !== e.nodeName) {
                    ...
                    return [
                        new h()
                            ...
                            .setValue(this.options._const.oldValue, D(t))
                            .setValue(this.options._const.newValue, D(e))
...
const j = (
    ...
    q = (
        ...
        if (
            ((D.attributes.class = c(D.attributes.class, r.table)), d || h || _)
        ) {
            const t = j(
                e,
                i,
...
const J = (t, e) => {
    ...
    Z = (t, e = void 0, s, n, a) => {
        ...
        if (t.headings) o.headings = t.headings.map((t) => X(t));
            ...
            e?.tBodies.length &&
                (o.headings = Array.from(e.tBodies[0].rows[0].cells).map((t) =>
                    X("")
                ));
        for (let t = 0; t < o.headings.length; t++)
            s[t] ||
                (s[t] = { type: n, format: a, sortable: !0, searchable: !0 });
        if (
            (t.data
                ? (o.data = t.data.map((t) => {
                      let e, i;
                      return (
                          ...
                          { attributes: e, cells: i.map((t, e) => Q(t, s[e])) }
                      );
                  }))
                : e?.tBodies?.length &&
            ...
            o.data.length && o.data[0].cells.length !== o.headings.length)
        )
...
class K {
    ...
    init() {
        [this.settings, this._state] = ((t = [], e, s) => {
            ...
            return (
                t.forEach((t) => {
                    (Array.isArray(t.select) ? t.select : [t.select]).forEach(
                        (o) => {
                            i[o]
    ...
    remove(t) {
        ...
        (this.dt.data.headings = this.dt.data.headings.filter(
            ...
            this.dt.data.data.forEach(
                (e) => (e.cells = e.cells.filter((e, s) => !t.includes(s)))
            ),
            this.dt.update(!0);
    }
    filter(t, e = !1) {
...
class it {
    ...
    init() {
        if (this.initialized || d(this.dom, this.options.classes.table))
            return !1;
        (this._virtualDOM = k(this.dom, this.options.diffDomOptions || {})),
    ...
    multiSearch(t) {
        ...
        this.data.data.forEach((t, e) => {
            const i = t.cells.map((t, e) => {
                ...
                const a =
                    i.searchItemSeparator || this.options.searchItemSeparator;
...
const nt = function (e) {
    ...
    ot = function (e, s = {}) {
        ...
        const i = {
            ...
            a = (t) =>
                !i.skipColumn.includes(t) && !e.columns.settings[t]?.hidden,
            o = e.data.headings
                .filter((t, e) => a(e))
                .map((t) => t.text ?? t.data);
        let r;
        if (i.selection)
            if (Array.isArray(i.selection)) {
                ...
                for (let t = 0; t < i.selection.length; t++)
                    r = r.concat(e.pages[i.selection[t] - 1].map((t) => t.row));
        ...
        if (
            ((l[0] = o),
            (l = l.concat(
                r.map((t) => t.cells.filter((t, e) => a(e)).map((t) => n(t)))
            )),
            l.length)
        ) {
            let t = "";
    ...
    rt = function (e, s = {}) {
        ...
        if (i.selection)
            if (Array.isArray(i.selection)) {
                o = [];
                for (let t = 0; t < i.selection.length; t++)
                    o = o.concat(e.pages[i.selection[t] - 1].map((t) => t.row));
...
class ht {
    ...
    editCell(t) {
        ...
        (this.data = { cell: i, rowIndex: s, columnIndex: e, content: n(i) }),
            (this.editing = !0),
            (this.editingCell = !0),
    ...
    saveCell(t) {
        ...
        if ("number" === s) n = { data: parseFloat(i) };
            ...
            n = { data: [{ nodeName: "#text", data: t }], text: t, order: t };
        ...
        (this.dt.data.data[this.data.rowIndex].cells[this.data.columnIndex] =
            n),
            this.closeModal();
    ...
    openMenu() {
        if (this.editing && this.data && this.editingCell) {
            const t = l(this.options.classes.input),
                e = this.modalDOM
                    ? this.modalDOM.querySelector(`input${t}[type=text]`)
                    : this.dt.wrapperDOM.querySelector(`input${t}[type=text]`);
            this.saveCell(e.value);
        }
...
const ut = function (t, e = {}) {
        const s = new ht(t, e);
        return (
            t.initialized ? s.init() : t.on("datatable.init", () => s.init()), s
        );
    },
    pt = {
        classes: {
