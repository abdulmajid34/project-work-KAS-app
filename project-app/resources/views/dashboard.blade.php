    ...
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            @if (Auth::user()->role == 'ketua_kelas')
                <a href="{{ url('/kelas') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Kelas</a>
            @elseif (Auth::user()->role == 'bendahara')
                <a href="{{ url('/pembayaran') }}"
                    class="text-sm text-gray-700 dark:text-gray-500 underline">Pembayaran</a>
                <a href="{{ url('/transaksi') }}"
                    class="text-sm text-gray-700 dark:text-gray-500 underline">Transaksi</a>
            @elseif (Auth::user()->role == 'admin')
                <a href="{{ url('/user') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">User</a>
            @elseif (Auth::user()->role == 'siswa')
                <a href="{{ url('/profile') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Profile</a>
            @endif
            <a href="/logout" class="text-sm text-gray-700 dark:text-gray-500 underline"
